...
- `/fases/[phaseSlug]` — vista de un bloque desbloqueado con sus módulos
- `/fases/[phaseSlug]/modulos/[moduleSlug]` — módulo con sus 5 secciones (intro → enseñanza → activación → evaluación → impartición)
