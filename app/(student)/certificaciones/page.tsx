...
export default async function CertificacionesPage() {
  return (
    <ComingSoonPage
      ...
      description="Acá vas a poder descargar todos tus certificados y compartir tus dimensiones obtenidas. Por ahora podés ver tu progreso y las dimensiones ganadas desde Mi Progreso."
      icon={Award}
