...
export const metadata: Metadata = {
  title: "DAP · Levantemos líderes juntos",
  description:
    "Una oportunidad especial para pastores y líderes: inscribe a 12 personas y cursa el Diplomado sin costo.",
  robots: {
    index: false,
    follow: false,
    nocache: true,
...
export default function DapPastoresTeamPage() {
  return (
    <main className="relative flex min-h-screen flex-col overflow-hidden bg-[#04081A] text-text-primary">
      ...
      <footer className="relative z-10 border-t border-white/[0.04] py-10 text-center">
        <p className="font-inter text-[11px] uppercase tracking-[0.32em] text-text-tertiary">
          DAP · Oportunidad exclusiva para líderes
        </p>
        <p className="mt-2 font-inter text-xs text-text-tertiary">
          Página privada. No compartir públicamente.
        </p>
      </footer>
    </main>
  );
