...
- `admin.ts` — cliente con `SUPABASE_SERVICE_ROLE_KEY` (solo route handlers que lo necesiten, ej. webhook de Stripe creando subscriptions y desbloqueando block_access).
