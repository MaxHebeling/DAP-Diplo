/**
 * Lista global de países para el onboarding internacional del DAP.
 *
 * Incluye los 195+ países reconocidos, con bandera emoji (Unicode
 * regional indicators) + ISO 3166-1 alpha-2 + nombre en español.
 * Las banderas son emojis nativos del SO — no requieren assets ni CDN.
 *
 * El onboarding muestra primero los países hispanos (LATAM + España)
 * como "destacados" porque el contenido del DAP es ES-only, después
 * el resto del mundo ordenado alfabéticamente para audiencia global.
 */

export type Country = {
  code: string;       // ISO 3166-1 alpha-2 (ej "MX", "AR")
  name: string;       // Nombre en español (ej "México", "Argentina")
  flag: string;       // Emoji bandera (ej "🇲🇽", "🇦🇷")
  dialCode: string;   // Prefijo telefónico (ej "+52", "+54")
  spanishSpeaking?: boolean; // Para destacar en el grid
};

export const COUNTRIES: Country[] = [
  // Spanish-speaking — featured first
  { code: "AR", name: "Argentina", flag: "🇦🇷", dialCode: "+54", spanishSpeaking: true },
  { code: "BO", name: "Bolivia", flag: "🇧🇴", dialCode: "+591", spanishSpeaking: true },
  { code: "CL", name: "Chile", flag: "🇨🇱", dialCode: "+56", spanishSpeaking: true },
  { code: "CO", name: "Colombia", flag: "🇨🇴", dialCode: "+57", spanishSpeaking: true },
  { code: "CR", name: "Costa Rica", flag: "🇨🇷", dialCode: "+506", spanishSpeaking: true },
  { code: "CU", name: "Cuba", flag: "🇨🇺", dialCode: "+53", spanishSpeaking: true },
  { code: "EC", name: "Ecuador", flag: "🇪🇨", dialCode: "+593", spanishSpeaking: true },
  { code: "SV", name: "El Salvador", flag: "🇸🇻", dialCode: "+503", spanishSpeaking: true },
  { code: "ES", name: "España", flag: "🇪🇸", dialCode: "+34", spanishSpeaking: true },
  { code: "US", name: "Estados Unidos", flag: "🇺🇸", dialCode: "+1", spanishSpeaking: true },
  { code: "GT", name: "Guatemala", flag: "🇬🇹", dialCode: "+502", spanishSpeaking: true },
  { code: "HN", name: "Honduras", flag: "🇭🇳", dialCode: "+504", spanishSpeaking: true },
  { code: "MX", name: "México", flag: "🇲🇽", dialCode: "+52", spanishSpeaking: true },
  { code: "NI", name: "Nicaragua", flag: "🇳🇮", dialCode: "+505", spanishSpeaking: true },
  { code: "PA", name: "Panamá", flag: "🇵🇦", dialCode: "+507", spanishSpeaking: true },
  { code: "PY", name: "Paraguay", flag: "🇵🇾", dialCode: "+595", spanishSpeaking: true },
  { code: "PE", name: "Perú", flag: "🇵🇪", dialCode: "+51", spanishSpeaking: true },
  { code: "PR", name: "Puerto Rico", flag: "🇵🇷", dialCode: "+1", spanishSpeaking: true },
  { code: "DO", name: "República Dominicana", flag: "🇩🇴", dialCode: "+1", spanishSpeaking: true },
  { code: "UY", name: "Uruguay", flag: "🇺🇾", dialCode: "+598", spanishSpeaking: true },
  { code: "VE", name: "Venezuela", flag: "🇻🇪", dialCode: "+58", spanishSpeaking: true },
  ...
  { code: "MM", name: "Birmania", flag: "🇲🇲", dialCode: "+95" },
  ...
  { code: "VA", name: "Ciudad del Vaticano", flag: "🇻🇦", dialCode: "+39" },
