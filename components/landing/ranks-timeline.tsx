    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        <div className="relative">
          <div
            aria-hidden
            className="absolute left-4 top-4 bottom-4 w-px bg-gradient-to-b from-brand-gold/40 via-white/10 to-brand-gold/40 lg:left-0 lg:right-0 lg:top-7 lg:h-px lg:w-auto lg:bg-gradient-to-r"
          />
            ...
            {ranks.map((r, i) => (
              <Reveal key={r.order_index} delay={i * 0.04}>
                <li className="relative pl-14 lg:pl-0 lg:pt-16">
                  <div className="absolute left-0 top-0 flex size-8 items-center justify-center rounded-full border border-brand-gold/40 bg-neutral-950 font-serif text-sm font-semibold text-brand-gold lg:left-1/2 lg:-translate-x-1/2">
                    {r.order_index}
                  </div>
